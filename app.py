...
#   ✅ Cover ใช้ข้อมูล "แถว 0 เสมอ" (บังคับ)
...
#   ✅ **ใหม่:** โหลด CSV หลักจาก GitHub อัตโนมัติถ้าไม่อัปโหลด (พร้อมสถานะ)
#
# Install deps:
...
'''
open('/mnt/data/streamlit_pdf_only_single_csv_app.py', 'w', encoding='utf-8').write(code)
print("Updated with auto-load main CSV from GitHub: /mnt/data/streamlit_pdf_only_single_csv_app.py")
